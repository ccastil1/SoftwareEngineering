...
# Backup master
server '54.213.130.187', port: 22, roles: [:web, :app, :db], primary: true
# File node 1
...
namespace :deploy do
  ...
  task :check_revision do
    on roles(:app) do
      unless `git rev-parse HEAD` == `git rev-parse origin/issue_26`
        puts "WARNING: HEAD is not the same as origin/issue_26"
